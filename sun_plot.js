...
//Ця штука справді знаходить правильні елементи, але не знає як змінити їх колір!!!!!!!!&&&&&&&&&&&&
//svg.selectAll(".line").on("mouseover", function(d) {console.log(document.getElementById(d.data.name)); });
